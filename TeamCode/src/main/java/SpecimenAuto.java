...
public class SpecimenAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        WayPoint depositPos1=new WayPoint(new Pose2D(DistanceUnit.INCH, -2, -50, AngleUnit.DEGREES, 90),
        ...
        WayPoint depositPos2=new WayPoint(new Pose2D(DistanceUnit.INCH, -2, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos12=new WayPoint(new Pose2D(DistanceUnit.INCH, -4, -50, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  4, 4, AngleUnit.DEGREES, 3));
        ...
        WayPoint depositPos22Strafe=new WayPoint(new Pose2D(DistanceUnit.INCH, -5, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        WayPoint depositPos13=new WayPoint(new Pose2D(DistanceUnit.INCH, -6.5, -50, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  4, 4, AngleUnit.DEGREES, 3));
        WayPoint depositPos23=new WayPoint(new Pose2D(DistanceUnit.INCH, -6.5, -24, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH,  1, 1, AngleUnit.DEGREES, 2));
        ...
        WayPoint specimenGrab2=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -51, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
        WayPoint specimenGrabForward2=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -56.5, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.5, 0.5, AngleUnit.DEGREES, 2));
        WayPoint specimenGrab3=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -51, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 1, 0.5, AngleUnit.DEGREES, 2));
        WayPoint specimenGrabForward3=new WayPoint(new Pose2D(DistanceUnit.INCH, 36, -56, AngleUnit.DEGREES, 90),
                new Pose2D(DistanceUnit.INCH, 0.5, 0.5, AngleUnit.DEGREES, 2));

        WayPoint park=new WayPoint(new Pose2D(DistanceUnit.INCH, 45, -48, AngleUnit.DEGREES, 180),
                new Pose2D(DistanceUnit.INCH, 1, 1, AngleUnit.DEGREES, 2));
