...
@Autonomous
public class SpecimenAutoPedroSix extends LinearOpMode {
    ...
    private final Pose preIntake1 = new Pose(18, -43, Math.toRadians(40));
    ...
    public static int extendAmount=200;
    ...
    enum AutoStates{depositPosPreload, retract,scorePreload, retract1, intakeReversePos, intakeReverse,
    ...
    public void runOpMode() throws InterruptedException {
        ...
        StateMachine specimenScorer = new StateMachineBuilder()
                ...
                .transition(() -> outtake.isRetracted() && outtake.getFlipAnalog()>1.937, SpecimenScoreStates.IDLE)
        ...
        PathChain scorePreload = follower.pathBuilder()
                ...
                .build();
        PathChain reversetointake1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(sampleReverse), new Point(preIntake1)))
                .setLinearHeadingInterpolation(sampleReverse.getHeading(), preIntake1.getHeading())
                .build();
        PathChain preloadScoretoreverse = follower.pathBuilder()
                .addPath(new BezierLine(new Point(preloadScorePose), new Point(sampleReverse)))
                .setLinearHeadingInterpolation(preloadScorePose.getHeading(), sampleReverse.getHeading())
                .build();
        ...
        PathChain score5topark = follower.pathBuilder()
        ...
        StateMachine autoMachine=new StateMachineBuilder()
                ...
                .onEnter(()->{
                    ...
                    intake.setTargetPos(extendAmount);
                })
                .transitionTimed(1.5)
                ...
                .onEnter(()->{
                    follower.followPath(reversetointake1, true);
                })
                .transitionTimed(0.7)
                ...
                .onEnter(()->{
                    follower.followPath(score5topark, true);
                })
                .transitionTimed(2)
        ...
        while (opModeInInit()) {
            ...
            telemetry.addData("Extend Amount", extendAmount);
            telemetry.update();
