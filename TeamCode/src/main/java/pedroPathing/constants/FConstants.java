...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 77.0;
        FollowerConstants.yMovement = 61.0;

        FollowerConstants.forwardZeroPowerAcceleration = -29.0;
        FollowerConstants.lateralZeroPowerAcceleration = -64.27;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.22,0,0.02,0);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.015,0,0.0001,0.6,0);//0.0001<- old d value
